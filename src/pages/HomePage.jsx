            ...
            <section className={`coffee-gradient text-white py-20 px-4 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                        <div>
                            <p className="text-amber-900 text-sm font-medium tracking-widest uppercase mb-3">Welcome to</p>
                            <h2 className="text-4xl md:text-5xl text-amber-900 font-bold font-serif leading-tight mb-4">
                                Kopi Terbaik dari<br />
                                <span className="text-amber-900">Bumi Nusantara</span>
                            </h2>
                            ...
                            <div className="flex flex-wrap gap-4">
                                    <Link to="/menu">
                                        <button className="px-8 py-3 bg-amber-400 hover:bg-amber-300 text-amber-900 font-bold rounded-xl transition-all duration-200 btn-coffee shadow-lg cursor-pointer">
                                            Lihat Menu ☕
                                        </button>
                                    </Link>
